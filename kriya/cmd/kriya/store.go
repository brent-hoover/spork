...
func migrations() []migration {
	return []migration{
		...
		{module: "planner", name: "0005_planned_ticket", stmts: splitSQL(planner.TicketMigration)},
		...
		{module: "planner", name: "0012_ticket_kind", stmts: splitSQL(planner.TicketKindMigration)},
		{module: "planner", name: "0013_ticket_slice", stmts: splitSQL(planner.TicketSliceMigration)},
		...
		{module: "orchestrator", name: "0006_pop_ordinal", stmts: splitSQL(orchestrator.PopMigration)},
		{module: "orchestrator", name: "0007_feed_cursor", stmts: splitSQL(orchestrator.CursorMigration)},
		{module: "orchestrator", name: "0008_branch_head", stmts: splitSQL(orchestrator.HeadMigration)},
		...
		{module: "devloop", name: "0006_session_sequence", stmts: splitSQL(devloop.SequenceMigration)},
